;(function (window) {
    ...
    var umlUC = function (element) {
        ...
        if (typeof element == "string") {
            ...
            console.log('parâmetro indefinido');
            return;
        }
...
//            interacionSingleClick(del);
        ...
        this.importFromXMLText = function (XMLString) {
            ...
            XMLString = XMLString.replace("Â«extendÂ»", "«extend»");
            XMLString = XMLString.replace("Â«includeÂ»", "«include»");
...
*/
            ...
            // diagrama altera seu tamanho conforme os componentes vão sendo inserids
