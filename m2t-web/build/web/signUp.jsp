...
<html lang="${language}">
    ...
    <body>
        <div id='pageContainer' role="main">
                    ...
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        <c:if test="${message != null}">
                            ...
                            <div class="form-bottom">
                                <form role="form" id="signUp" action="ServletController1" method="get">
                                    <input type="hidden" name="action" value="SignUp" />
                                    <div class="form-group input-group">
                                        <label class="sr-only" for="personName"><fmt:message key="sign-up.personName" /></label>
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-text-color"></i></span>
                                        <input id="username" type="text" class="form-control" name="personName" required aria-required="true" value="" placeholder="<fmt:message key="sign-up.personName-placehoder" />">
                                    </div>
                                    <div class="form-group input-group">
                                    ...
                                    <div class="form-group">
                                        <p><strong><fmt:message key="sign-up.visualImpairment" /></strong></p>
                                        <label class="radio-inline"><input type="radio" name="visualImpairment" value="0" required aria-required="true"><fmt:message key="sign-up.sighted" /></label>
                                        <label class="radio-inline"><input type="radio" name="visualImpairment" value="1" required aria-required="true" checked="checked"><fmt:message key="sign-up.blind" /></label>
                                        <label class="radio-inline"><input type="radio" name="visualImpairment" value="2" required aria-required="true" checked="checked"><fmt:message key="sign-up.partialVision" /></label>
                                    </div>
                                    <div class="form-group">
                                        <p><strong><fmt:message key="sign-up.studiedComputing" /></strong></p>
                                        <label class="radio-inline"><input type="radio" name="studiedComputing" value="0" required aria-required="true"><fmt:message key="sign-up.haveNeverStudied" /></label>
                                        <label class="radio-inline"><input type="radio" name="studiedComputing" value="1" required aria-required="true" checked="checked"><fmt:message key="sign-up.studied" /></label>
                                        <label class="radio-inline"><input type="radio" name="studiedComputing" value="2" required aria-required="true" checked="checked"><fmt:message key="sign-up.studying" /></label>
                                    </div>
            ...
            <div class="navbar navbar-fixed-bottom footer"><p><fmt:message key="footer.start" />&nbsp;<fmt:message key="footer.end" />. leandro.luque@gmail.com</p></div>
        </div>
