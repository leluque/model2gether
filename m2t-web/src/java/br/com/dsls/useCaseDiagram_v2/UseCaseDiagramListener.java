...
public interface UseCaseDiagramListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by the {@code relationInheUC}
	 * labeled alternative in {@link UseCaseDiagramParser#relation}.
	 * @param ctx the parse tree
	 */
	void enterRelationInheUC(@NotNull UseCaseDiagramParser.RelationInheUCContext ctx);
	/**
	 * Exit a parse tree produced by the {@code relationInheUC}
	 * labeled alternative in {@link UseCaseDiagramParser#relation}.
	 * @param ctx the parse tree
	 */
	void exitRelationInheUC(@NotNull UseCaseDiagramParser.RelationInheUCContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code relationInheAct}
	 * labeled alternative in {@link UseCaseDiagramParser#relation}.
	 * @param ctx the parse tree
	 */
	void enterRelationInheAct(@NotNull UseCaseDiagramParser.RelationInheActContext ctx);
	/**
	 * Exit a parse tree produced by the {@code relationInheAct}
	 * labeled alternative in {@link UseCaseDiagramParser#relation}.
	 * @param ctx the parse tree
	 */
	void exitRelationInheAct(@NotNull UseCaseDiagramParser.RelationInheActContext ctx);
	/**
